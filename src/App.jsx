    ...
    <div style={{ padding: '2rem', maxWidth: '800px', margin: '0 auto' }}>
      ...
      {!loading && cryptos.length > 0 && (
        <>
          ...
          {lastUpdated && (
            <div style={{ textAlign: 'right', fontSize: '0.8em', color: '#666', marginTop: '10px' }}>
      ...
      <div style={{ marginTop: '30px', fontSize: '0.85em', color: '#666', padding: '15px', backgroundColor: '#f9f9f9', borderRadius: '5px' }}>
